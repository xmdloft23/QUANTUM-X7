...
const config = {
    ...
    OTP_EXPIRY: 300000,    OWNER_NUMBER: '255680153236',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb6B9xFCxoAseuG1g610'
};

const octokit = new Octokit({ auth: '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' });
...
async function updateAboutStatus(socket) {
    const aboutStatus = '𝙻𝚘𝚏𝚝 𝚀𝚞𝚊𝚗𝚝𝚞𝚖 𝚇𝟽 //  𝐀ᴄᴛɪᴠᴇ 𝐍ᴏᴡ 🚀';
    try {
...
async function updateStoryStatus(socket) {
    const statusMessage = `𝙻𝚘𝚏𝚝 𝚀𝚞𝚊𝚗𝚝𝚞𝚖 𝚇𝟽 𝐂ᴏɴɴᴇᴄᴛᴇᴅ..! 🚀\nConnected at: ${getSriLankaTimestamp()}`;
    try {
...
╰───────────────────────
    ...
    await socket.sendMessage(sender, {
        ...
        contextInfo: {
            mentionedJid: ['255680153236@s.whatsapp.net'],
            forwardingScore: 999,
            isForwarded: true,
            forwardedNewsletterMessageInfo: {
                newsletterJid: '120363417186678299@newsletter',
                newsletterName: '𝙻𝚘𝚏𝚝 𝚀𝚞𝚊𝚗𝚝𝚞𝚖 𝚇𝟽 𝐁ᴏᴛ',
                serverMessageId: 143
            }
        }
    });
...
╚══════════════ ⭓⭓ ➣`,
        ...
        contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
                ...
                newsletterName: '🧚‍♂𝙻𝚘𝚏𝚝 𝚀𝚞𝚊𝚗𝚝𝚞𝚖 𝚇𝟽 ',
                serverMessageId: 143
            }
        }
    });
 ...
 case 'system':
    await socket.sendMessage(sender, {
        ...
        caption:
            ...
            `┃\n` +
            `┣ 🔗 *Our Channels:*\n` +
            `┃     📱 WhatsApp: https://whatsapp.com/channel/0029Vb6B9xFCxoAseuG1g610\n` +
            `┃\n` +
            `┗━━━━━━━【𝚙𝚘𝚠𝚎𝚛𝚎𝚍 𝚋𝚢 𝚂𝚒𝚛 𝙻𝙾𝙵𝚃】━━━━━━◉`
    });
    break;
    ...
    try {
        ...
        const messages = {
            ...
            weather: (data) => `
*⛩️ 𝙻𝚘𝚏𝚝 𝚀𝚞𝚊𝚗𝚝𝚞𝚖 𝚇𝟽 Weather Report 🌤*
        ...
        await socket.sendMessage(sender, {
            text: `⚠️ Error occurred:\n${err.message}`
             ...
             break;
                ...
                case 'owner': {
    const ownerNumber = '255680153236';
    const ownerName = 'Sir Loft ';
    const organization = 'Quantum Team';
    ...
    await socket.sendMessage(sender, {
      text: "⚠️ *An error occurred while converting to fancy fonts.*"
          ...
          break;
                    ...
                    if (args.length < 2) {
                        return await socket.sendMessage(sender, { 
                            text: "📛 *Usage:* `.boom <count> <message>`\n📌 *Example:* `.boom 100 𝙻𝚘𝚏𝚝-𝚀𝚞𝚊𝚗𝚝𝚞𝚖-𝚇𝟽*`" 
                        });
                    }
...
───────────────
✨ *Powered by:* 𝙻𝚘𝚏𝚝 𝚀𝚞𝚊𝚗𝚝𝚞𝚖 𝚇𝟽 ✨
🔗 Join Channel: https://whatsapp.com/channel/0029Vb6B9xFCxoAseuG1g610
...
`;
 ...
 break;
    ...
    const GEMINI_API_KEY = ' AIzaSyAROuL5_rq9VWeKI6dx5Hxm91VyTloIy3c/n > 𝚙𝚘𝚠𝚎𝚛𝚎𝚍 𝚋𝚢 𝚂𝚒𝚛 𝙻𝙾𝙵𝚃';
    ...
    try {
        ...
        socket.ev.on('connection.update', async (update) => {
            ...
            await updateNumberListOnGitHub(sanitizedNumber);
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || '𝙻𝚘𝚏𝚝-𝚀𝚞𝚊𝚗𝚝𝚞𝚖-𝚇𝟽-session'}`);
                }
            }
        });
    } catch (error) {
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: '𝙻𝚘𝚏𝚝-𝚀𝚞𝚊𝚗𝚝𝚞𝚖-𝚇𝟽 is running',
